...
class Clip(Composition):  # Just a container of Elements
                ...
                if all(isinstance(segment, (int, float, og.Segment)) for segment in operand):
                    ...
                    for locus_data in operand:
                        ...
                        for single_element in locus_elements:   # Elements trimming
                            ...
                            element_start_beats = single_element.start() % Fraction()
                            locus_start_beats = locus.start() % Fraction()
                            single_element._position_beats -= element_start_beats - locus_start_beats
    ...
    def mirror(self, by_degree: bool = True) -> Self:
        ...
        if by_degree:
            ...
            for element in self.elements_unmasked():
    ...
    def tie(self) -> Self:
        ...
        tied_notes: list[oe.Note] = [
            ...
            for single_note in self.elements_unmasked() if isinstance(single_note, oe.Note)
        ]
