...
kick_snare = kick + snare + rest << TrackName("Kick & Snare") << Odd()**Dotted(1/8) << Even()**Duration(1/16) >> Stack()
# kick_snare * 4 >> Plot(True, composition=open_hat)



rhythm_solution = RS_Clip(kick_snare * 4, composition=open_hat * 4)
moved_beats = rhythm_solution.swap_loci(-10, by_channel=True).solution()
