...
chromatic_notes /= 2
chromatic_notes.select(Beat(0)).arpeggiate("Up")
chromatic_notes.select(Beat(1)).arpeggiate("Down")
...
chromatic_order /= 2
chromatic_order.select(Beat(0)).arpeggiate("Up")
chromatic_order.select(Beat(1)).arpeggiate("Down")
