...
new_durations = RS_Clip(melody_6_00, [1], 8)\
    .duration_rearrangement(10, [1/16, 1/8, 1/4, 0, 0, 0])\
    .solution() << Title("Final Solution")

new_durations % [Position(), float()] >> Print()
new_durations % [Duration(), float()] >> Print()
new_durations >> Plot()
