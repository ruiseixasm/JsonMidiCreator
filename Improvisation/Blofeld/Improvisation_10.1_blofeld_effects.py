...
level_cc = ControlChange(Blofeld.midi_cc["EFFECTS"]["Mix 1"]) * 16 << Iterate(step=1000)
level_cc * 4 + long_note_c >> P

print("2nd LOOP")

automation_cc = Clip() >> Automate([95, 50, 20, 50, 90, 100], "1... 1.1. .1.. ..11", Blofeld.midi_cc["EFFECTS"]["Mix 2"])
