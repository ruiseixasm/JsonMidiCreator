...
multi_notes = Null() >> first_note * 3 >> Play(1) >> Save("_MultiElements_jsonMidiCreator.json") >> Print() >> Export("_Play2_jsonMidiPlayer.json")

first_note << Key("F") >> Play()
first_note << Load("_Note_jsonMidiCreator.json") >> Play()
