...
def test_enharmonic_key():
    ...
    assert key_signature.is_enharmonic_2nd(5)
    ...
    assert key_signature.is_enharmonic_2nd(0)
    assert key_signature.is_enharmonic_2nd(5)
    ...
    assert key_signature.is_enharmonic_2nd(11)
    ...
    assert key_signature.is_enharmonic_2nd(4)
    assert key_signature.is_enharmonic_2nd(11)
