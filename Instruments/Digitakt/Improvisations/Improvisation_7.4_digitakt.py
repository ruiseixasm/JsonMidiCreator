...
close_hats_clip = Note(closed_hat, 1/16) * 16 << Name("Closed Hat")
...
complete_part = Section(open_hats_clip, close_hats_clip, tom_clip, snare_clip, kick_clip) * 4

snare_tom_part = Section(tom_clip, snare_clip) * 4
