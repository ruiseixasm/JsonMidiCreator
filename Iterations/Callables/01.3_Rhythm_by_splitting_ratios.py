...
notes_splitter = I_Splitter(6, chaos=SinX(540), pre_exclusion=exclusion, post_processing=post_processing, packed_repeats=4, max_tries=1000, no_repetitions=True)
