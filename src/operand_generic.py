...
class Pitch(Generic):
            ...
            case od.DataSource():
                match operand % o.Operand():
                    ...
                    case str():
                        ...
                        note_key += 12 * (self._flat._unit != 0)   # second line of the list
    ...
    def getSerialization(self) -> dict:
        ...
        serialization["parameters"]["key_key"]          = self.serialize( self._key )
    ...
    def loadSerialization(self, serialization: dict) -> 'Pitch':
        if isinstance(serialization, dict) and ("class" in serialization and serialization["class"] == self.__class__.__name__ and "parameters" in serialization and
            ...
            self._key           = self.deserialize( serialization["parameters"]["key_key"] )
    ...
    def __lshift__(self, operand: o.Operand) -> 'Pitch':
        ...
        match operand:
            ...
            case od.DataSource():
                match operand % o.Operand():
                    case ou.Octave():
                        self._octave    = operand % o.Operand()
                    case ou.Key():
