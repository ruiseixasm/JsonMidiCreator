...
class Element(o.Operand):
    ...
    def __rrshift__(self: TypeElement, operand: o.Operand) -> TypeElement:
    ...
    def __iadd__(self: TypeElement, operand: any) -> Union[TypeElement, 'Clip']:
        import operand_container as oc
        operand = self & operand    # Processes the tailed self operands or the Frame operand if any exists
        match operand:
            case Element():
    ...
    def __isub__(self: TypeElement, operand: any) -> TypeElement:
        operand = self & operand    # Processes the tailed self operands or the Frame operand if any exists
        match operand:
            # For efficient reasons
            case ra.Position():
    ...
    def __imul__(self: TypeElement, operand: any) -> Union[TypeElement, 'Clip']:
        import operand_container as oc
    ...
    def __itruediv__(self: TypeElement, operand: o.Operand) -> TypeElement:
        operand = self & operand    # Processes the tailed self operands or the Frame operand if any exists
        if operand != 0:
            self_operand: any = self % operand
            self_operand /= operand
