...
class Composition(Container):
    ...
    def __eq__(self, other: o.Operand) -> bool:
        match other:
            ...
            case oy.Yielder():
                return self.__eq__( Clip(other._element._time_signature, other) )
            case _:
                return super().__eq__(other)
...
class Clip(Composition):  # Just a container of Elements
    ...
    def __iadd__(self, operand: any) -> Self:
        match operand:
            ...
            case oy.Yielder():
                return self.__iadd__( Clip(operand._element._time_signature, operand) )
    ...
    def __isub__(self, operand: any) -> Self:
        match operand:
            ...
            case oy.Yielder():
                return self.__isub__( Clip(operand._element._time_signature, operand) )
            case oe.Element():
                return self._delete([ operand ])
            case list():
                if all(isinstance(item, oe.Element) for item in operand):
    ...
    def __imul__(self, operand: any) -> Self:
        match operand:
            ...
            case oy.Yielder():
                return self.__imul__( Clip(operand._element._time_signature, operand) )
            case oe.Element():
    ...
    def __itruediv__(self, operand: any) -> Self:
        match operand:
            ...
            case oy.Yielder():
                return self.__itruediv__( Clip(operand._element._time_signature, operand) )
            case oe.Element():
    ...
    def __ifloordiv__(self, operand: any) -> Self:
        match operand:
            ...
            case oy.Yielder():
                return self.__ifloordiv__( Clip(operand._element._time_signature, operand) )
            case oe.Element():
                split_position: ra.Position = operand.start()
                position_offset: ra.Position = operand.finish() - split_position
                self //= split_position
