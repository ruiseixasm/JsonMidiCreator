...
class Staff(o.Operand):
    def __init__(self):
        ...
        self._scale: od.GenericScale                       = od.GenericScale("Major")
    ...
    def __eq__(self, other_staff: 'Staff') -> bool:
        ...
        return  self._measure           == other_staff % od.DataSource( ov.Measure() ) \
            ...
            and self._scale             == other_staff % od.DataSource( od.GenericScale() ) \
    ...
    def __lshift__(self, operand: o.Operand) -> 'Staff':
        match operand:
            ...
            case Staff():
                ...
                self._scale             = operand % od.DataSource( od.GenericScale() )
            ...
            case od.GenericScale():            self._scale << operand
