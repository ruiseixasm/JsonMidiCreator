...
clap: Trk = Nt(Dur(defaults % Quant()), DrumKit("Clap"), Stackable(False)) * 2 + Iterate(Beats(1))**Position() + Beats(1)
...
syncopation_1: Trk = no_syncopation + wood_block
syncopation_1 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_2: Trk = no_syncopation + (wood_block << 1/16)
syncopation_2 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_3: Trk = no_syncopation + (wood_block + All()**Step(1) << 1/16)
syncopation_3 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_4: Trk = no_syncopation + (wood_block + All()**Step(2) << 1/16)
syncopation_4 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_5: Trk = no_syncopation + (wood_block + All()**Step(3) << 1/16)
syncopation_5 >> Play(1)
print("Delay for 0.5 seconds")
time.sleep(0.5)

# Best outcome with some extra variation
syncopation_6: Trk = no_syncopation + (wood_block + Nths(5)**Step(1) << 1/16)
syncopation_6 >> Play(1)
print("Delay for 0.5 seconds")
time.sleep(0.5)

# Best outcome with some extra variation
syncopation_7: Trk = no_syncopation + (wood_block + Nths(4)**Step(1) + Nths(5)**Step(1) << 1/16)
