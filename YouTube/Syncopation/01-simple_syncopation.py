...
syncopation_3: Seq = no_syncopation + (wood_block + All()**Step(1) << 1/16)
syncopation_3 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_4: Seq = no_syncopation + (wood_block + All()**Step(2) << 1/16)
syncopation_4 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_5: Seq = no_syncopation + (wood_block + All()**Step(3) << 1/16)
