...
clap: Seq = Nt(Dur(staff % Quant()), DrumKit("Clap"), Stackable(False)) * 2 + Iterate(Beats(1))**Position() + All()**Beats(1)
...
syncopation_3: Seq = no_syncopation + (base_line + All()**Step(1) << 1/16)
syncopation_3 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_4: Seq = no_syncopation + (base_line + All()**Step(2) << 1/16)
syncopation_4 >> Play()
print("Delay for 0.5 seconds")
time.sleep(0.5)

syncopation_5: Seq = no_syncopation + (base_line + All()**Step(3) << 1/16)
