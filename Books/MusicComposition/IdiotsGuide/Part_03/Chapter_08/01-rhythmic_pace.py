...
variation_a + Note("C", 5, 1/2, Gate(1), Position(Beat(2))) >> Link()
...
variation_f: Sequence = ((original_phrase | Measures(0) | Less(Beat(3))).copy() << Gate(1)) + original_phrase << Equal(Measures(0))**NoteValue(1/8) >> Sort()
