...
structural_tones: Clip = Note("E", Duration(1)) * 4 + Loop(0, 2, 2, 4)
...
all_notes + Loop(Octave(1), 3, 4, Degree(5), 0, 1, Degree(3), 3, 4, Degree(5)) >> Rest() >> Play()
