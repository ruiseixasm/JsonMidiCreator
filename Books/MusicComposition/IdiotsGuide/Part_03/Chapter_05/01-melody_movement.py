...
movement << Match(Measures(3))**Pitch("D", 5) << Match(Measures(3))**NoteValue(1) \
         << Match(Measures(0))**Key("E") << Match(Measures(1))**Key("G") << Match(Measures(2))**Key("B")
movement += Match(Measures(0))**Iterate()**Key()
movement += Match(Measures(1))**Iterate()**Key()
movement += Match(Measures(2))**Iterate()**Key()
movement >> Play(True)
