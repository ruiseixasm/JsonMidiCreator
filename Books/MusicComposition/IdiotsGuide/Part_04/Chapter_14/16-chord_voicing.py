...
violin_1    << Foreach(5, 1, 5, 3)**Degree()    # Different Voicing
violin_2    << Foreach(3, 5, 3, 1)**Degree()    # Different Voicing
viola       << Foreach(1, 3, 1, 5)**Degree()    # Different Voicing
cello       << Foreach(1, 1, 1, 1)**Degree()    # Different Voicing
...
different_voicing: Part = Part([violin_1, violin_2, viola, cello])
