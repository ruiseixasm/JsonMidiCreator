...
parallel_1 = Note(1/1, Degree(6)) / 4 << Name("Parallel Motion")
parallel_1 += motion
...
similar_1 = Note(1/1, Octave(5), Degree(1)) / 4 << Name("Similar Motion")
...
oblique_1 = Note(1/1, Degree(5)) / 4 << Name("Oblique Motion")
oblique_1 += motion
...
contrary_1 = Note(1/1, Degree(5)) / 4 << Name("Contrary Motion")
contrary_1 += motion
