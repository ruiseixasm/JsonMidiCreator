...
if False:
    ...
    theme_2 = RS_Clip(theme_2, [1], 4, theme_1).key_pattern(5).solution() << Name("Similar")
    ...
    final_composition = RS_Clip(final_composition, [1], 4, theme_1).mask(Channel(2)).key_pattern(5).unmask().solution()
