...
right_hand = Clip("1  5  4  5  3  4  2  3  1")
right_hand << Last()**(Beats(2), Velocity(60))
left_hand = Clip("1  5  4  5  3  4  2  3  1") << Octave(3)
...
right_hand + left_hand + right_hand_mirrored + left_hand_mirrored >> Plot(title="Exercise 2")
