...
(Chord(1/4) * 7 << Size("7th")) << Even()**Increment()**Degree(2) << Even()**Increment()**Mode(2) >> Print() >> Play(True)
(Chord(1/4) * 7 << Size("7th")) << Increment()**Even()**Degree() << Increment()**Even()**Mode() >> Print() >> Play(True)
