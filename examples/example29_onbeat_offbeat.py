...
snare << Select(OnBeat()) >> Plot(block=False, title="On Beat")
snare << Select(OffBeat()) >> Plot(block=False, title="Off Beat")
snare << Select(DownBeat()) >> Plot(block=False, title="Down Beat")
